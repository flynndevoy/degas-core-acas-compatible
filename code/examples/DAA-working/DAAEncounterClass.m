...
% DAAENCOUNTERCLASS Example Simulink model of a mitigated two aircraft encounter 
    ...
    methods        
        ...
        function theSim = setupEncounter( theSim, encNumber, samples)
            ...
            theSim.ac1NominalEvents.event = DAAEncounterClass.extractEncounterEvent(enc2Load.updates(1));
            theSim.ac2NominalEvents.event = DAAEncounterClass.extractEncounterEvent(enc2Load.updates(2));
    ...
    methods(Static, Access=private)
        function eventMatrix = extractEncounterEvent(update)
            eventMatrix = [];
